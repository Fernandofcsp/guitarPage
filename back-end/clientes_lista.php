...
<html>
					...
					$.ajax({
						...
						success  : function(resultband) {
							if (resultband==1){  //bandera
								...
								$('#mensaje').html('Usuario eliminado').show(); //Permite que se vuelva a mostrar despues de ser ocultado
	...
	<?php include("Menu.php"); ?>
        ...
        <div class=contenedor-fila height="50" align="center">
			<div class=contenedor-cabecera colspan="6" style="font-size: 25px">Lista de Clientes</div>
		</div>
		...
		<div class=contenedor-fila id="filacampos" height="200" align="center" valign="middle">
			...
			<div class=contenedor-nombre >Nombre completo</div>
            <div class=contenedor-correo >Correo</div>
            <div class=contenedor-rol >Nivel</div>
            <div class=contenedor-2boton >Acciones</div>
        </div>
        ...
        echo "<div class=contenedor-roldatos width=\"33.33%\">$nivel_txt</div>";
		echo "<div class=contenedor-botondatos width=\"50%\"><input type=\"button\" style=\"background-color:#00ffff;border-color:black;padding:3px;\" id =\"vdet\" value=\"Ver detalle\" onclick = \"location='clientes_detalle.php?id=$id'\" ></div>";
		echo "<div class=contenedor-botondatos width=\"50%\"><input type=\"button\" style=\"background-color:#FFFFFF;border-color:black;padding:3px;\" id =\"vedit\" value=\"Ver pedidos\" onclick = \"location='cliente_pedidos.php?id=$id'\" ></div>";
